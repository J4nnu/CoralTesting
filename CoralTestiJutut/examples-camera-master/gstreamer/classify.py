...
def main():
    ...
    default_model = 'mobilenet_v2_1.0_224_quant_edgetpu.tflite' #mobilenet_ssd_v1_coco_quant_postprocess_edgetpu.tflite
    default_labels = 'imagenet_labels.txt' #coco_labels.txt
